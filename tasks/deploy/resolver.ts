...
task("deploy-resolver", "Deploy only the OMA3 Resolver contract")
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    console.log("\n2. Update contract-addresses.txt active deployment section with this new resolver address");
    console.log("3. Update hardhat.config.ts NETWORK_CONTRACTS with this resolver address");
    console.log("4. Update frontend src/config/chains.ts with this resolver address");
    console.log("\n5. Configure resolver settings (optional):");
    ...
    console.log("\n6. Authorize attestation issuers and update contract-addresses.txt Issuers section:");
